    ...
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40">
          {/* Single card */}
          <a
            href="https://play.google.com/store/apps/details?id=com.unionsg.akrbank"
          ...
          {/* Single card */}
          <a
            href="https://play.google.com/store/apps/details?id=com.unionsg.qr_merchant"
          ...
          {/* Single card */}
          <a
            href="https://github.com/king-d-dev/share-dist"
